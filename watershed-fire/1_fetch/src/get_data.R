...
#' 
#' This function downloads, unzips and reads the fire perimeter shapefile from MTBS.gov
#' 
#' @param url The url for the MTBS fire occurrence dataset (zip format).
#' @param perim_zip_path The file path and name and extension for the downloaded zip file.
